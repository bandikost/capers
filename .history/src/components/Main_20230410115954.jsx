...
const Main = () => {
  ...
  const handleBalanceUpdate = () => {
    const balanceRef = firebase.database().ref("balance");
    const previousBalance = balance.user1; // save the previous balance
    balanceRef.update({
      user1: parseInt(newBalance),
      lastBalance: previousBalance, // set lastBalance to the previous balance
    });
    setNewBalance(""); // clear the input field
  };
